...
def parse_cl():
    ...
    parser.add_argument('-p', '--port', metavar='Port', type=int, default=8099, help='TCP port to test (default: 443)')
    ...
    parser.add_argument('-c', '--concur', metavar='Concur', type=int, default=1, help='Number of concurrent clients (default: 1)')
...
def worker():
    ...
    #time.sleep(random.random() * whole_exp_time)
...
if __name__ == '__main__':
    ...
    print "Sleep 3 seconds to wait ab warm up"

    time.sleep(3)

    for i in range(opts.concur):
